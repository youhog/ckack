<template>
  <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6">
    ...
    <div v-else class="space-y-3">
      ...
      <div v-for="zone in sortedZones" :key="zone.id" class="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-slate-50 dark:bg-slate-900/30 rounded-lg p-4 gap-4 border border-slate-200 dark:border-slate-700">
